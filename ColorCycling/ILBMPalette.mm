...
{
    animatedColors = new std::unordered_map<NSInteger, ILBMColor *>();
...
std::vector<ILBMColor *> * ILBMPalette::colorsForFrame(NSInteger frame)
{
    if (!colorFrameCache)
    {
...
{
    NSInteger cycleSize = (cycle->high - cycle->low) + 1;
